...
for r in r_values:
    line1, =plt.plot(q_values, instance.lam_two_dim_eucl(q=q_values, r=r, real_k=True, exact=True, smallest=smallest),
...
if smallest:
    plt.savefig('figures/10000_2d_eucl_smallest.svg', format='svg', dpi=1000)
else:
