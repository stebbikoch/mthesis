...
f3 = open('/run/user/1000/gvfs/sftp:host=taurus.hrsk.tu-dresden.de,user=s8583916/home/h3/s8583916/home/scratch/s8583916-stefans_ws/mthesis/results/2d_max_norm_undirected_10000_100xshort.json')
...
for r in r_values:
    #line1, =plt.plot(q_values, [instance.second_lam_two_dim(q=q, r=r) for q in q_values], label=r'$r_0={}~(k={})$'.format(r, (2*r+1)**2-1))#, color=c[index])
    ...
    line5 = plt.hlines(yu2, 0.5, 1.5, linewidth=0.4, color=line2.get_color(), linestyles='--')
...
plt.savefig('figures/10000_2d_max_norm_smallest.svg', format='svg', dpi=1000)
plt.show()